        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4 lg:gap-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-sm text-muted-foreground leading-relaxed">
              Human-Centered Care, <br />Enhanced by Technology
            </p>
            ...
            <div className="mt-6 flex space-x-4">
              ...
              >
                <div className="w-10 h-10 flex items-center justify-center rounded-full bg-[#9d9af0] hover:bg-[#93bddc] transition-colors">
                  <svg
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link
                  href="mailto:info@visual-thinking.pt"
                  className="text-sm text-muted-foreground hover:text-foreground hover:underline transition-all duration-200 ease-in-out"
                >
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
            <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-6">
              ...
              <Link
                ...
                rel="noopener noreferrer"
              >
                Powered by <span className="text-[#87bee6] transition-all duration-200 ease-in-out">Visual Thinking</span>
              </Link>
