...
export function ScrollToTopButton() {
  ...
  return (
    <button
      onClick={scrollToTop}
      className={`fixed bottom-6 left-6 z-50 p-3 rounded-full text-white shadow-lg transition-all duration-300 hover:brightness-110 focus:outline-none
        ${isVisible ? "opacity-100" : "opacity-0 pointer-events-none"}
        sm:bottom-8 sm:left-8 sm:p-4`}
